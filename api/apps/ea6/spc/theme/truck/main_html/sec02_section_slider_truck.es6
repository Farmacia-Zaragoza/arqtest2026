...
const 	{ html_style } 				= 	require(	cons.JS_BASE + 'com/objects/html/html_style.es6'										),		
		{ flx03_div_flex_slider }	= 	require(	cons.JS_BASE + 'spc/theme/truck/deep_html/types/slider/flx03_div_flex_slider.es6'		),
		{ flx03_div_flex_carousel }	= 	require(	cons.JS_BASE + 'spc/theme/truck/deep_html/types/slider/flx03_div_flex_carousel.es6'		),
		{ mob03_div_flex_mobile }	= 	require(	cons.JS_BASE + 'spc/theme/truck/deep_html/types/mobile_contacts/mob03_div_mobile.es6'	),
