...
const 	{ html_style } 			= require(path.join(JS_BASE, 'com/objects/html/html_style.es6'))
		...
		const { hea01_head_truck } = require(path.join(JS_BASE, 'spc/theme/truck/main_html/hea01_head_truck.es6'))
		const { bdy01_body_truck } = require(path.join(JS_BASE, 'spc/theme/truck/main_html/bdy01_body_truck.es6'))
