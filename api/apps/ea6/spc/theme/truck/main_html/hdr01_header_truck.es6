// [DOCHANGED_ES6]
// ==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
// Truck Header Class  [V.0.0.5]  (2017-08-10)
...
//      <a class="logo" href="index.html"><img src="img/brqx_logo_transporteslucasrivera_2017_transparent.svg" alt=""></a>
//		<div class="pop-container"> - External
//      <a class="logo rightLogo" href="index.html"><img src="img/brqx_logo_transporteslucasrivera_2017_transparent_rotated.svg" alt=""></a>
...
const 	{ html_style } 				= 	require(	path.join(JS_BASE, 'com/objects/html/html_style.es6'));
		...
		const { hdr02_div_header_truck }	= 	require(	path.join(JS_BASE, 'spc/theme/truck/deep_html/types/header/hdr02_div.es6'));

class hdr01_header_truck extends html_style  {
	...
	// Html strings
		...
		this.div_01				=	new hdr02_div_header_truck(	this.thm					)
