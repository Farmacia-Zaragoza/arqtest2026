...
const 	{ html_style } 					= require(	cons.JS_BASE + 'com/objects/html/html_style.es6'												),
		...
		{ mai03_div_email }				= require( 	cons.JS_BASE + 'spc/theme/truck/deep_html/types/email/mai03_div_mail.es6'							),
		{ phn03_div_phone }				= require( 	cons.JS_BASE + 'spc/theme/truck/deep_html/types/phone/phn03_div_phone.es6'						),
		{ dli01_div_list }				= require( 	cons.JS_BASE + 'spc/theme/truck/deep_html/types/desc_list/dli01_desc_list.es6'					),
		{ des02_div_descriptions }		= require( 	cons.JS_BASE + 'spc/theme/truck/deep_html/types/descriptions/des02_div_descriptions.es6'	);
