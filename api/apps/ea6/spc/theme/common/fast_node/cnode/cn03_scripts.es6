// ==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
// Node Js - Composition_For_Scripts  [V.0.0.1]  (2017-12-02)
...
var 	cons 					= 	require("/brqx/base/rcode/ea6/com/libs/general/constants.ea6"	);
...
class cn03_scripts extends pcomp {
    ...
    constructor (	u	 				= 	''				,	// 01. Url Object   
					...
					stype				=	'script_compo'	)   // 04. Node Type
    {   
		...
		this.suffix								=	 'zone_' + compo_zone	+ "_" + this.s.env + "_" + this.s.live_opt			 
