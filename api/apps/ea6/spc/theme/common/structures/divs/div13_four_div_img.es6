...
class div13_four_div_img extends html_style {
		constructor() {
				super(...arguments);
				this.n = "div13_four_div_img::";
		}

		constructor(div_01_class = "", div_02_class = "", div_03_class = "", div_04_class = "", img_01_class = "", img_01_alt = "") //Check Ok [17-09-29]
		//$this->dd('Code > ' . $this->code)										;
		{
				this.tag_type = "div";
				super.constructor(this.tag_type);
				this.class = div_01_class;
				this.div_01 = new div12_three_div_img(div_02_class, div_03_class, div_04_class, img_01_class, img_01_alt);
