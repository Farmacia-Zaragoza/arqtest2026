...
class div11_two_div_img extends html_style {
		constructor() {
				super(...arguments);
				this.n = "div11_two_div_img::";
		}

		constructor(div_01_class = "", div_02_class = "", img_01_class = "", img_01_alt = "") //Check Ok [17-09-29]
		//$this->dd('Code > ' . $this->code)										;
		{
				this.tag_type = "div";
				super.constructor(this.tag_type);
				this.class = div_01_class;
				this.div_01 = new div10_div_img(div_02_class, img_01_class, img_01_alt);
