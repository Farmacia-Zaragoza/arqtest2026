...
//		{ sec02_process_se5 } 		= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/se/sec02_process_se1.es6'),
//		{ sec02_process_sa5 } 		= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/sa/sec02_process_sa1.es6'));


class sec02_process_se4 extends html_style {

	constructor() 
	{
		super()
		this.n 					= 	"sec02_process_se4::"
	...
	choose_process_sa()
	{
		...
		if 			(this.level_sa === 0 ) this.elem_sa			= 	new sec02_process_sa5()
	}
	...
	choose_process_se()
	{
		...
		if 			(this.level_se === 0 ) this.elem_se			= 	new sec02_process_se5()
	}
...
exports.sec02_process_se4 = sec02_process_se4