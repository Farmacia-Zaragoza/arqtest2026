...
const 	{ html_style } 				= 	require(	path.join(JS_BASE, 'com/objects/html/html_style.es6')),
		...
		{ sec02_process_se2 } 		= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/se/sec02_process_se2.es6')),
		{ sec02_process_sa2 } 		= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/sa/sec02_process_sa2.es6'));


class sec02_process_se1 extends html_style {

	constructor() 
	{
		super()
		this.n 					= 	"sec02_process_se1::"
	...
	choose_process_sa()
	{
		...
		if 			(this.level_sa === 0 ) this.elem_sa			= 	new sec02_process_sa2()
	}
	...
	choose_process_se()
	{
		...
		if 			(this.level_se === 0 ) this.elem_se			= 	new sec02_process_se2()
	}
...
exports.sec02_process_se1 = sec02_process_se1