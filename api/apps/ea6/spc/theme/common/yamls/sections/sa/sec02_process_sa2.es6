...
const 	{ html_style } 			= 	require(	cons.JS_BASE 	+ 	'com/objects/html/html_style.es6'									),
		...
		{ sec02_process_se3 } 	= 	require(	cons.JS_BASE 	+ 'spc/theme/common/yamls/sections/se/sec02_process_se3.es6'				),
		{ sec02_process_sa3 } 	= 	require(	cons.JS_BASE 	+ 'spc/theme/common/yamls/sections/sa/sec02_process_sa3.es6'				);
