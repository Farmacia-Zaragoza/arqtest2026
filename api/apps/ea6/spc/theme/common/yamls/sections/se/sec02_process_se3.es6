...
class sec02_process_se3 extends html_style {

	constructor() 
	{
		super()
		this.n 					= 	"sec02_process_se3::"
	...
	choose_process_sa()
	{
		...
		if 			(this.level_sa === 0 ) this.elem_sa			= 	new sec02_process_sa4()
	}
	...
	choose_process_se()
	{
		...
		if 			(this.level_se === 0 ) this.elem_se			= 	new sec02_process_se4()
	}
...
exports.sec02_process_se3 = sec02_process_se3
