...
const 	{ html_style } 			= 	require(	cons.JS_BASE 	+ 	'com/objects/html/html_style.es6'									),
		...
		{ sec02_process_sa1 } 	= 	require(	cons.JS_BASE 	+	'spc/theme/common/yamls/sections/sa/sec02_process_sa1.es6'			),
		{ sec02_process_se1 } 	= 	require(	cons.JS_BASE 	+ 	'spc/theme/common/yamls/sections/se/sec02_process_se1.es6'			);
...
class sec02_process_se_ext extends html_style {
	...
	constructor() 
	{
		// SABEMOS QUE ES UN SORTED ELEM

		super()
		this.n 					= 	"sec02_process_se_ext::"
...
//		if 			(this.level_sa === 1 ) 
	...
	process_se()
	{
			 ...
			 ( this.se.type === 'sorted_elem' )	)
		{
			...
			{
				this.parent_title 			= 		this.se.tit 
				this.elem_title 			= 		new sec02_process_tit(this.parent_title , this.level_sa, this.maxdim ) 
...
exports.sec02_process_se_ext = sec02_process_se_ext