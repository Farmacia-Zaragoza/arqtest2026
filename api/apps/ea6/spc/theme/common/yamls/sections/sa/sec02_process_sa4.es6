...
//		{ sec02_process_se5 } 	= 	require(	cons.JS_BASE 	+ 'spc/theme/common/yamls/sections/se/sec02_process_se5.es6'			),
//		{ sec02_process_sa5 } 	= 	require(	cons.JS_BASE 	+ 'spc/theme/common/yamls/sections/sa/sec02_process_sa5.es6'			);
