...
//		{ sec02_process_se5 } 	= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/se/sec02_process_se5.es6')),
//		{ sec02_process_sa5 } 	= 	require(	path.join(JS_BASE, 'spc/theme/common/yamls/sections/sa/sec02_process_sa5.es6'));


class sec02_process_sa4 extends html_style {

	constructor() 
	{
		super()
		this.n 					= 	"sec02_process_sa4::"
...
exports.sec02_process_sa4 = sec02_process_sa4