...
const 	{ html_style } 			= 	require(	path.join(JS_BASE, 'com/objects/html/html_style.es6')),
		...
		{ hea01_head_dog }	= 	require(	path.join(JS_BASE, 'spc/theme/dog/main_html/hea01_head_dog.es6')),
		{ bdy01_body_dog }	= 	require(	path.join(JS_BASE, 'spc/theme/dog/main_html/bdy01_body_dog.es6'));
...
class htm01_html_dog extends html_style  {
    ...
    create_head()
    {
		// External Head
		this.head_01	=
				new hea01_head_dog(this.thm)	// Drupal theme structure
...
//		this.content			+=  '<HEAD>HOLA</HEAD>' //this.head_01.code
    ...
    create_body()
    {
		// External Div
		this.body_01	=
				new bdy01_body_dog( this.thm )	// Drupal theme structure
