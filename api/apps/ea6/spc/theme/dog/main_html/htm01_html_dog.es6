...
const 	{ html_style } 			= 	require(	cons.JS_BASE + 'com/objects/html/html_style.es6'					),
		...
		{ hea01_head_dog }	= 	require(	cons.JS_BASE + 'spc/theme/dog/main_html/hea01_head_dog.es6'		),
		{ bdy01_body_dog }	= 	require(	cons.JS_BASE + 'spc/theme/dog/main_html/bdy01_body_dog.es6'		);
