...
const 	{ html_style } 					= 	require(	cons.JS_BASE 	+ 	'com/objects/html/html_style.es6'							),		
		...
		{ ctn01_container_dog }			= 	require(	cons.JS_BASE 	+ 	'spc/theme/dog/main_html/ctn01_container_dog.es6'			),					
		{ scr02_fbjs_script_dog }		= 	require(	cons.JS_BASE 	+ 	'spc/theme/dog/deep_html/scripts/scr02_fbjs_script_dog.es6'	),					
		{ scr01_js_dog }				= 	require(	cons.JS_BASE 	+ 	'spc/theme/dog/main_html/scr01_js_dog.es6'					),					
