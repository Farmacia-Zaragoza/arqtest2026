...
const 	{ html_style } 				= 	require(	path.join(JS_BASE, 'com/objects/html/html_style.es6'))),
		{ flx03_div_flex_slider }	= 	require(	path.join(JS_BASE, 'spc/theme/dog/deep_html/slider/flx03_div_flex_slider.es6'))),
		{ flx03_div_flex_carousel }	= 	require(	path.join(JS_BASE, 'spc/theme/dog/deep_html/slider/flx03_div_flex_carousel.es6'))),
		{ mob03_div_flex_mobile }	= 	require(	path.join(JS_BASE, 'spc/theme/dog/deep_html/mobile_contacts/mob03_div_mobile.es6'))),
