...
const 	{ getset } 						= 	require(	cons.JS_BASE + 'com/objects/html/getset.es6'										),		
		...
		{ scr05_js_inline_dog }			= 	require(	cons.JS_BASE + 'spc/theme/dog/deep_html/scripts/scr05_js_inline_dog.es6'	),
		{ scr06_js_async_dog }			= 	require(	cons.JS_BASE + 'spc/theme/dog/deep_html/scripts/scr06_js_async_dog.es6'				),
