...
//- create_code     : Create div_NN   dhtml object
//==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--

var { html_style } 		= require(	'/brqx/base/rcode/es6/com/objects/html/html_style.es6'		)

class lst01_script_jquery extends html_style {

	constructor(vnode = "", jnode = "") 
	{
		this.tag_type = "script";

		this.n = "lst01_script_mid::";
		this.arr_resolutions = Array();
	...
	create_code() 
	{
		...
		this.j.dolar_almocreate("FotoListados_middle00-pill-tab", "listView");
...
exports.lst01_script_jquery = lst01_script_jquery
