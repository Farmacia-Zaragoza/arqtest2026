...
class fn08_paisfada extends fnode {

	constructor(nid_object = "", u = "", nid_id = "", position_id = "", stype = "paisfada") 
	{
		super()
		this.n = "fn08_paisfada::"
		...
		this.suffix_code = this.suffix + "_code" + ".country"
	...
	load_child_details() {
		if (this.s.load == "drupal") {
			...
			this.load_multi_fields("field_lista_enlace_%02d", "tit url", "title_url", 60)
		}
	}
