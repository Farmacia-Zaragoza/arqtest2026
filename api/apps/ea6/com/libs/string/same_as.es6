...
//print "Model - " . $model_phrase . "\n\r"   
{
	...
	if (ctype_upper(char_01) and ctype_upper(char_02)) //print "MAY - " . $char_01 . $char_02 . ' + ' . $model . "- \n\r"   
		{
			return str_in.toUpperCase()
		} else if (ctype_lower(char_01) and ctype_lower(char_02)) //print "MIN - " . $char_01 . $char_02 . ' + ' . $model . "- \n\r"   
		{
			return str_in.toLowerCase()
		} else if (ctype_upper(char_01) and ctype_lower(char_02)) return ucfirst(str_in)else //ALERT SAME_AS - _ + _-
