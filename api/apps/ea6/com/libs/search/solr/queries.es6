...
const	mat					= require( 	'/brqx/base/rcode/es6/com/libs/string/match.es6'			),
		path 				= require(	'path'														),
		fs 					= require(	'fs'														),
		os					= require(	'os'														),
		empty	 			= require(	'/brqx/base/react/zcommon/node_modules/is_empty'			),
		is_numeric 			= require(	'/brqx/base/react/zcommon/node_modules/isnumeric'			),
		ucfirst 			= require(	'/brqx/base/react/zcommon/node_modules/ucfirst'				),
