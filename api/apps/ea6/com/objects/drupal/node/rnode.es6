...
class fnode extends anode {
	...
	{
		this.arr['properties'].push("title" + this.sep + this.title)
		...
		this.arr['properties'].push("path" + this.sep + this.path)
	}
