...
// Methods:
//-------------------------------------------------------------------------------------
// - d-check_only_if_is_needed_to_reload_type_ram-	: 	Check reload and reload_type
// - d-check_only_if_is_needed_to_reload_type_ssd-	: 	Check reload and reload_type
// - d-check_only_if_is_needed_to_reload_type_disk-	: 	Check reload and reload_type
// ==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--

var 	cons 				= 	require("/brqx/base/rcode/ea6/com/libs/general/constants.ess"								);

var { anode_check_only_if_is_needed_to_reload_code } 		= require(	cons.JS_BASE + 'com/objects/drupal/anode/an2/an23_check_only_if_is_needed_to_reload_code.es6'		)
