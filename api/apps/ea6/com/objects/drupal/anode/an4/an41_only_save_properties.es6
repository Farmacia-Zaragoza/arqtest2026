...
var { anode_only_save_code } 		= require(	cons.JS_BASE + 'com/objects/drupal/anode/an4/an42_only_save_code.es6'		),
	fs 								= require(	'fs'				)															,
	cff  							= require( 	cons.JS_BASE + 'com/libs/file/full_path/level_02/create_full_filename.es6' ),
	cpf  							= require( 	cons.JS_BASE + 'com/libs/file/full_path/level_02/copy_full_filename.es6' ),
